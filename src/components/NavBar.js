      ...
      return (
        <div className='navbar'>
          ...
          <div className='button-click'> 
            <button className='button-text' onClick={this.handleClick('/login')}>Login</button>
          </div>
        </div>
      );
    }
    ...
    return (
      <div className='navbar'>
        ...
        <div className='link-click2'> 
          <Link className={!this.props.hasNotifs ? 'link-text' : 'link-text2'} to='/notifications'>Notifications</Link>
        </div>
        <div className='link-click'>
          <Link className='link-text' to='/profile/tp'>Profile</Link>
        </div>
        <div className='button-click'>
          <button className='button-text' onClick={() => {this.props.firebase.logout();window.location.href="/"}} >Logout</button>
        </div>
      </div>
    );
  }
